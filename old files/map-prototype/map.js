...
//GREG, this is where we need to swap the variable.
//variable controls positioning
var currentLevel = 1;
...
const traverse = () => {
	...
	if (currentLevel == 1) {
		...
		$("#ascend-button").css("filter", "brightness(0.8)")
	...
	//set state for base level with only Ancients grid showing
		...
		$("#descend-button").css("filter", "brightness(0.7)")
